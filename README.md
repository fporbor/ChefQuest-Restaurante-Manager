...
ID,Requisito / Funcionalidad,Rama / Artefacto,Estado
* **REQ-01**,Entorno de desarrollo (Docker/PostgreSQL),infraestructura-docker,Completado
* **REQ-02**,"Lógica de negocio (Vistas, Models, Forms)",rama-angel,Completado
* **REQ-03**,Monitorización (Middleware personalizado),chefquest/middleware.py,Completado
* **REQ-04**,Gestión de usuarios y Admin,rama-angel / main,Completado
* **REQ-05**,Integración Continua (Merge),main,Completado
* **REQ-06**,Documentación del Workflow,README.md,Completado
### Extras opcionales:
